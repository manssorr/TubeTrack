...
import { ChevronDown, ChevronRight, PlayCircle, Clock, Trash2, Book, TrendingUp, Zap } from "lucide-react";
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    <Card>
                        <CardContent className="flex items-center p-6">
                            ...
                            <div>
                                <p className="text-2xl font-bold">{playlistsArray.length}</p>
                    ...
                    <Card>
                        <CardContent className="flex items-center p-6">
                            ...
                            <div>
                                <p className="text-2xl font-bold">{Math.round((completedVideos / Math.max(totalVideos, 1)) * 100)}%</p>
            ...
            {playlistsArray.length > 0 ? (
                <div>
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <Badge variant="secondary" className="text-sm">
                            {playlistsArray.length} playlist{playlistsArray.length !== 1 ? 's' : ''} • {totalVideos} videos
                        </Badge>
                    </div>
                ...
                <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground mb-6">
                        Import your first YouTube playlist to begin tracking your progress!
                    </p>
                </div>
            )}
        </div>
